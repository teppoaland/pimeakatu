...
| Makuuhuone (ex-palkintohuone, talo 7) | **Aina auki, ei lukkoa** (v4.43: ei avaimia eikä lamppua – pelaaja päättää itse, milloin nukkuu; kolikkoreitti **poistettu** 20.9.2026/v4.33) · Nuku / Poistu = **ilmainen**, ei vaikuta talouteen | `street.js` |
